...
export default function App() {
  ...
  useEffect(() => {
    ...
    ws.onmessage = (e) => {
      ...
      [span_4](start_span)// 1. QUANT ENGINE: GARCH-M & SIGMA[span_4](end_span)
      ...
      [span_5](start_span)// 2. PERSISTENCE: TICK vs STEALTH[span_5](end_span)
      setMetrics(prev => ({
        ...prev,
        ticks: { 
      ...
      [span_6](start_span)// 3. FLUX WAVE: EMA-SMOOTHED RSI[span_6](end_span)
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white p-4 font-sans select-none">
      ...
      [span_7](start_span){/* SEGMENT 1: PRICE & AGGRESSIVE TRIANGLES[span_7](end_span) */}
      ...
      [span_8](start_span){/* SEGMENT 2: STEALTH FLOW BAR[span_8](end_span) */}
      <div className={cardBase}>
      ...
      [span_9](start_span){/* SEGMENT 3: SIGMA BIDIRECTIONAL[span_9](end_span) */}
      <div className={cardBase}>
      ...
      [span_10](start_span){/* SEGMENT 4: FLUX WAVE VISUALS[span_10](end_span) */}
      <div className={cardBase}>
        <div className="flex justify-between items-center mb-2">
